      ...
      <div className="w-full h-full px-2  sm:px-8 py-7 rounded-2xl flex flex-col border border-zinc-300 shadow-xl bg-gradient-to-b to-zinc-50 from-zinc-100">
        <div className="flex flex-col">
          <div className="flex flex-row items-center h-[80px]">
            ...
            <div className="w-[14%] sm:w-[10%] h-full flex justify-center items-center bg-zinc-200 text-zinc-500 text-center sm:py-1 text-xs sm:text-lg">
              <p>Pretador de <br /> serviço</p>
            </div>
            <div className="w-[14%] sm:w-[10%] h-full flex justify-center items-center bg-zinc-500 text-zinc-50 text-center sm:py-1 text-xs sm:text-lg">
              <p>Outras<br /> agências</p>
            </div>
            <div className="w-[14%] sm:w-[10%] h-full flex justify-center items-center bg-zinc-100 text-zinc-950 text-center py-1 text-xs sm:text-lg">
              <p>Cami<br /> agência</p>
            </div>
          </div>
        </div>
