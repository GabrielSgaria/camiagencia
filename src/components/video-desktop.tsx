...
export default function VideoDesktop() {
    return (
        <div className="flex items-center justify-center md:h-[435px]  lg:h-[520px] xl:h-[648px] container mx-auto mt-10 relative px-0" id="about">
            <iframe className="md:w-full lg:w-[90%] h-full relative z-0" src="https://www.youtube.com/embed/_zu1wB6aO2E?autoplay=1&mute=1" title="YouTube video player" allow='autoplay'></iframe>
